(function () {
  ...
  const translations = {
    en: {
      ...
      'gp.figs.burst.l': 'more generations per second after moving the engine to Burst jobs',
    ...
    pl: {
      ...
      'gp.figs.burst.v': '2,2–2,5×',
      'gp.figs.burst.l': 'więcej pokoleń na sekundę po przeniesieniu silnika na zadania Burst',
      'gp.figs.device.v': '64 → 141/s',
